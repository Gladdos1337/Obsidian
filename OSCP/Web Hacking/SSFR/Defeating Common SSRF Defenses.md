...
**An attacker could quickly circumvent this rule by creating a subdomain on an attacker's domain name such as [htt](https://website.thm.attackers-domain.thm)**
...
eg. https://website.thm/link?=url=https://tryhackme.com

This endpoint was created to record the number of times visitors have clicked on this link for advertising/marketing purposes. But imagine there was a potential SSRF vuln with stringent rules which only allowed URL's begging with https://website.thm/. 

**An attacker could use the above feature to redirect the interal HTTP request to a domain of attackers choice.**
